      ...
      <div>
        ...
        <div className='border-l-2 border-blue-400 pl-4'>
          <p className='text-blue-100 text-sm leading-relaxed mb-4'>
            "PostPilot helped us cut our content scheduling time in half.
            Posting across every platform finally feels effortless."
          </p>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-xs text-blue-200'>Marketing Lead at Nimbus</p>
            </div>
          </div>
        </div>
      </div>
