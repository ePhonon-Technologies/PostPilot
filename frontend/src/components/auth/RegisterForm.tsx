...
function RegisterForm() {
  ...
  const handleGoogleSignup = () => {
    ...
    if (!baseUrl) {
      toast.error('the backend url is missing', baseUrl);
    }
  ...
  return (
    <div className='flex flex-col justify-center px-8 py-12 sm:px-16'>
      <div className='flex items-center gap-2 mb-10'>
        ...
        <span className='font-semibold text-gray-900 text-lg'>PostPilot</span>
      </div>
      ...
      <p className='text-sm text-gray-500 mb-8'>
        Sign up to start scheduling and managing posts across all your social
        platforms.
      </p>
